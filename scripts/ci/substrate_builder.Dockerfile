...
LABEL description="Multistage Docker image for Substrate: a platform for web3" \
	...
	io.parity.image.source="https://github.com/dojimanetwork/substrate-node/blob/${VCS_REF}/scripts/ci/substrate_builder.Dockerfile" \
	io.parity.image.documentation="https://github.com/dojimanetwork/substrate-node/"
